app.component('skills-sandy-goreraza', {
 ...
 <!-- section skills -->
		<section id="skills" class="shadow-blue white-bg padding">
			...
			<!--<p class="mb-0">Sandy Goreraza skills</p>-->
			...
			<div class="row mt-5">
				...
				<div class="col-md-6">
					...
					<div class="skill-item">
						<div class="skill-info clearfix">
							<h4 class="float-left mb-3 mt-0">Flask</h4>
							<span class="float-right">80%</span>
						</div>
						<div class="progress">
							<div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80">
				...
				<div class="col-md-6">
					...
					<div class="skill-item">
						<div class="skill-info clearfix">
							<h4 class="float-left mb-3 mt-0">Codeignitor</h4>
							<span class="float-right">80%</span>
						</div>
						<div class="progress">
							<div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80">
...
<div class="row mt-5">
				...
				<div class="col-md-6">
					...
					<div class="skill-item">
						<div class="skill-info clearfix">
							<h4 class="float-left mb-3 mt-0">WhatsApp Chatbot API</h4>
							<span class="float-right">60%</span>
						</div>
						<div class="progress">
							<div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="60">
